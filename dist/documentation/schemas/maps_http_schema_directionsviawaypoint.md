...
| `step_interpolation` | optional | integer                                         | <div class="nonref-property-description"><p>The position of the waypoint along the step's polyine, expressed as a ratio from 0 to 1.</p></div>          |
